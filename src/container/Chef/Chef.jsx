      ...
      <div className="app__owner-content">
        <div className="app__owner-content_quote">
          <p className='p__opensans'>
            Anomaly started with humble beginnings, a lot of faith, and a dream to build something of our own. Today, we're proud to call both Berwick and Williamsport, Pennsylvania our home.
